<%@ Page Title=" View Blood Bank" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewBloodBank.aspx.cs" Inherits="HospitalManagementSystem.PatientAccount.ViewBloodBank" %>
      ...
      <nav class="navbar navbar-side" role="navigation">
          ...
          <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                      <div class="page-head-line">  View Blood Bank
                       ...
                       <div class="panel-body">
                           ...
                           <div class="navtab">
                              <ul class="nav nav-tabs">
                                <li class="active"><a href="#" data-toggle="tab" style=" width: 304px"><i class="fa fa-navicon"></i>View BloodBank</a>
                                </li>
                                <li>
