<%@ Page Title=" View Doctor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewDoctor.aspx.cs" Inherits="HospitalManagementSystem.PatientAccount.ViewDoctor" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="navtab">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#" data-toggle="tab"><i class="fa fa-navicon"></i>View Doctor</a>
                                        </li>
                                        <li></li>
