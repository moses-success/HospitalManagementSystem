<%@ Page Title="Operational History" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperationHistory.aspx.cs" Inherits="HospitalManagementSystem.PatientAccount.OperationHistory" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="navtab">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#" data-toggle="tab" style="width: 350px"><i class="fa fa-navicon"></i>Operational Histroy</a>
                                        </li>
                                        <li></li>
